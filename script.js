...
let col = [{ "color": "red" }, { "color": "blueviole" }, { "color": "yellow" }, { "color": "green" }, { "color": "" }, { "color": "red" }
]

function refreshPage() {
  let index = Math.floor(Math.random() * (myjokes.length - 1))
  let index1 = Math.floor(Math.random() * (col.length - 1))
  console.log(index)
  document.getElementById("joke").innerHTML = myjokes[index].joke
  document.getElementById("joke").style.color = col[index1].color
